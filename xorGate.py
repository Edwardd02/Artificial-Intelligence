...
for i in range(0, len(test)):
    h1 = sigmoid(bias[0] + listWeights[0][0] * test[i][0] + listWeights[1][0] * test[i][1])
    h2 = sigmoid(bias[1] + listWeights[0][1] * test[i][0] + listWeights[1][1] * test[i][1])
    h3 = sigmoid(bias[2] + listWeights[0][2] * test[i][0] + listWeights[1][2] * test[i][1])
    output = sigmoid(biasZ + listZs[0] * h1 + listZs[1] * h2 + listZs[2] * h3)
